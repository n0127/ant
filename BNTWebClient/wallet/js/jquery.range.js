...
//			console.log()
			if(this.labels[1].innerText>="0" && this.labels[1].innerText<="25"){
				console.log(1)
				$(".selected-bar").css("width","0")
				$(".last-active").css("left","-6px")
			}else if(this.labels[1].innerText>"25" && this.labels[1].innerText<"75"){
				console.log(2)
				$(".selected-bar").css("width","50%")
				$(".last-active").css("left","50%")
			}else{
				console.log(3)
				$(".selected-bar").css("width","100%")
				$(".last-active").css("left","98%")
			}
		...
		setInputValue: function(pointer, v) {
			...
			if(this.inputNode.val() !== this.options.value) {
				...
				var inputVal = this.inputNode.val();
				$('.num-ETH>span').text(inputVal)
			}
		},
		getValue: function() {
