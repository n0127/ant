(function() {
	...
	e.modules = {}, e.aliases = {}, e.resolve = function(t) {
		...
		for(var s = [t, t + ".js", t + ".json", t + "/index.js", t + "/index.json"], n = 0; s.length > n; n += 1) {
			var t = s[n];
		...
		e = e.split("/"), t = t.split("/");
		for(var n = 0; t.length > n; n += 1) {
			".." == t[n] ? e.pop() : "." != t[n] && "" != t[n] && s.push(t[n])
		}
		...
		if(!e.modules.hasOwnProperty(t)) {
			throw Error('Failed to alias "' + t + '", it does not exist')
		}
		e.aliases[s] = t
		...
		function n(e, t) {
			...
			for(var s = i.all(t, e.parentNode), n = 0; s.length > n; n += 1) {
				if(s[n] == e) {
					return !0
				}
			}
		...
		function n(e) {
			if(!e) {
				throw Error("A DOM element reference is required")
			}
		...
		s.exports = function(e) {
			...
			for(var t = this.array(), s = 0; t.length > s; s += 1) {
				e.test(t[s]) && this.remove(t[s])
			}
			return this
		...
		s.exports = n, n.prototype.on = n.prototype.addEventListener = function(e, t) {
			...
			if(s) {
				s = s.slice(0);
				for(var n = 0, i = s.length; i > n; n += 1) {
					s[n].apply(this, t)
				}
			}
			return this
		...
		e.find = function(e, t) {
			var s = null,
				n = null,
				o = t[0];
			for(i = 0; t.length > i; i += 1) {
				s = Math.abs(e - o), n = Math.abs(e - t[i]), s > n && (o = t[i])
			}
			return o
		}
		...
		function n() {
			...
			if(t.length) {
				return "function" != typeof t[0] ? e.merge(t) : (e.inherits.apply(null, t), void 0)
			}
		}
		...
		e.extend = function(t, s) {
			...
			for(var t = 2 === e.length ? e.shift() : {}, s = null, n = 0, i = e.length; i > n; n += 1) {
				s = e[n];
				for(var o in s) {
